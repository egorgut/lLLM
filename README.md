...
покрывает девять категорий (без инструмента, калькулятор, SQL, восстановление
после ошибки SQL, несколько инструментов подряд, MCP-время, повтор вызова,
бюджет вызовов, таймаут).
