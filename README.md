...
За один ход по-прежнему исполняется **один** инструмент.
...
один ход по-прежнему исполняется **один** инструмент. Полноценный agent-loop с
несколькими вызовами за ход, само-коррекция SQL и несколько MCP-серверов
